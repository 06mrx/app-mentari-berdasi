...
import BottomNavHeadmaster from './BottomNavHeadmaster'
import BottomNavTPK from './BottomNavTpk'
        ...
        <div className='flex overflow-hidden bg-base-100 min-h'>
          ...
          <div className='text-base flex-1 h-screen overflow-auto'>
            ...
            <div className='p-3 min-h-[calc(100vh-65px)] bg-base-200' style={{ backgroundImage: "url('/assets/images/bgg.svg')", }}>
              ...
              {
                storageService.checkRole(user.role_id) == 'Kepala Sekolah' ? <BottomNavHeadmaster /> : null
              }
              {
                storageService.checkRole(user.role_id) == 'Guru' ? <BottomNavTPK /> : null
              }
            </div>
