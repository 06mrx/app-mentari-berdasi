...
function Index() {
    ...
    const { data: students, mutate } = useSWR(process.env.API + '/api/headmaster/student-personal-data/index?page=' + (router.query.page ? router.query.page : '') + '&search=' + (router.query.search ? router.query.search : '') + '&unit_id=' + (router.query.unit_id ? router.query.unit_id : ''), fetcher);
    let filterTimeout;
    const doSearch = (event) => {
        clearTimeout(filterTimeout)
        filterTimeout = setTimeout(() => {
            router.push({
                pathname: '/headmaster/students',
    ...
    return <>
        <PageLayout title={'Daftar Siswa PAUD'} hasBackUrl={true} backUrl="/headmaster">
            <div className="flex flex-col md:flex-row lg:flex-row w-full  justify-center items-center gap-3">
                <div className="flex flex-col w-full md:w-6/12 lg:w-6/12">
            ...
            <div className="overflow-x-auto w-full mt-3 max-w-screen-2xl mx-auto">
                <div className="flex w-full justify-end">
                    <Link href={'/headmaster/students/create'}>
                                ...
                                return (
                                    <tr className="hover" key={index}>
                                        ...
                                        <td>
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div>Umur : {monthDiff(student.birth_date)} Bulan</div>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 24 24"><path fill="#ffb266" d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM21.41 6.34l-3.75-3.75l-2.53 2.54l3.75 3.75l2.53-2.54z"></path></svg>
                                                ...
                                                <Link href={'/headmaster/students/' + student.id}>
