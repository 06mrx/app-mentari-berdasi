...
export default function Create() {
    return <>
        <PageLayout title={'Tambah Data Perkembangan Anak'} hasBackUrl={true} backUrl="/teacher/1">
            <div className="max-w-5xl mx-auto rounded-2xl shadow-lg p-3 bg-base-100">
                ...
                <div className="form-control w-full">
                    <label className="label">
                        ...
                        <span className="label-text-alt  font-semibold">* Tidak Wajib</span>
                    </label>
                    <textarea placeholder="Masukkan catatan untuk siswa jika ada" className="textarea w-full input-bordered" >
