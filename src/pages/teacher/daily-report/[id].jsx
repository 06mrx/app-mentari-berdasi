...
export default function Create() {
    ...
    useEffect(() => {
        if(router.isReady) {
            fetch(process.env.API + '/api/teacher/daily-report/show/' + router.query.id, {
                method: 'GET',
                headers : {
                    'Authorization': token
                }
    ...
    const handleSubmit = event => {
        ...
        postData.append('duration', formData.duration.current.value ? formData.duration.current.value : formData.duration.current)
        ...
        fetch(process.env.API + '/api/teacher/daily-report/update/' + id, {
            method: 'POST',
            headers: {
                'Authorization': token,
            },
