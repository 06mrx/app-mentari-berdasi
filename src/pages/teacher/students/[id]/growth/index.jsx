...
export default function Index() {
    ...
    const { data: growthDevelopments, mutate } = useSWR(process.env.API + '/api/teacher/growth-development/index/' + id, id ? fetcher : null);
    ...
    if (!growthDevelopments) return <>
        <PageLayout title={'Intervensi Pertumbuhan Peserta Didik'} hasBackUrl={true} backUrl={"/teacher/students/" + id}>
    ...
    return <>
        <PageLayout title={'Pertumbuhan Siswa'} hasBackUrl={true} backUrl={'/teacher/students/' + id}>
                            ...
                            growthDevelopments.data?.map((growthDevelopment, index) => {
                                return (
                                    <tr className="hover" key={index}>
                                        ...
                                        <td>
                                            <Link href={'/teacher/students/' + id + '/growth/' + growthDevelopment?.student_weight_development_id + '/' + growthDevelopment?.student_height_development_id + '/edit'}>
