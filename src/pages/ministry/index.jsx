...
function Index() {
    ...
    const { data, error } = useSWR(process.env.API + '/api/health-worker/dashboard/index', fetcher);
                ...
                <div className="mockup-code bg-emerald-400 text-primary-content p-3">
                    <span className="">
                        <span className="text-xl md:text-2xl lg:text-3xl">
                            Hai <span className="font-bold text-orange-500">{storageService.getName()}</span>, Selamat Datang di Aplikasi <span className="text-orange-500 font-semibold">SIPAUD</span> !
                        </span>
