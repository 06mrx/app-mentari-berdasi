...
export default function Create() {
    ...
    const handleSubmit = (event) => {
        ...
        fetch(process.env.API + '/api/reference/work_unit/store', {
            method: 'POST',
            headers: {
                'Authorization': token,
    ...
    if (!villages) {
        return (
            <PageLayout title={'Tambah Unit Kerja'} hasBackUrl={true} backUrl="/administrator/reference/work-unit">
    ...
    return <>
        <PageLayout title={'Tambah Unit Kerja'} hasBackUrl={true} backUrl="/administrator/reference/work-unit">
            ...
            <div className="max-w-5xl mx-auto rounded-2xl shadow-lg p-3 bg-base-100">
                <p className="text-2xl">Form Tambah Unit Kerja</p>
                <form onSubmit={handleSubmit}>
                    <div className="flex gap-0 md:gap-3 lg:gap-3 md:flex-row lg:flex-row flex-col">
                        <div className="form-control w-full">
                            ...
                            <input placeholder="Masukkan Nama Unit Kerja / Sekolah" className="input input-sm w-full input-bordered" ref={formData.name} />
                            <label className="label">
                        ...
                        <div className="form-control w-full">
                            ...
                            <input placeholder="Masukkan Nomor Registrasi" className="input input-sm w-full input-bordered" ref={formData.registration_number} />
                            <label className="label">
                        ...
                        <div className="form-control w-full">
                            ...
                            <input placeholder="Masukkan Akreditasi jika ada" className="input input-sm w-full input-bordered" ref={formData.accreditation} />
                            <label className="label">
                    ...
                    <div className="form-control w-full">
                        ...
                        <select className="select select-sm w-full select-bordered font-normal" defaultValue={''} ref={formData.unit_form}>
                    ...
                    <div className="flex gap-0 md:gap-3 lg:gap-3 md:flex-row lg:flex-row flex-col">
                        <div className="form-control w-full">
                            ...
                            <input placeholder="Masukkan email" type="email" className="input input-sm w-full input-bordered" ref={formData.email} />
                            <label className="label">
                        ...
                        <div className="form-control w-full">
                            ...
                            <input placeholder="Masukkan Website" className="input input-sm w-full input-bordered" ref={formData.website} />
                            <label className="label">
                        ...
                        <div className="form-control w-full">
                            ...
                            <input placeholder="Masukkan No. HP / Kontak" className="input input-sm w-full input-bordered" ref={formData.phone_number} />
                            <label className="label">
                    ...
                    <div className="flex flex-col md:flex-row lg:flex-row md:gap-3 lg:gap-3">
                        <div className="form-control w-full">
                            ...
                            <input placeholder="Masukkan Alamat / Nama Jalan" className="input input-sm w-full input-bordered" ref={formData.address} />
                            <label className="label">
                        ...
                        <div className="form-control w-full">
                            ...
                            <input placeholder="Masukkan Kode pos" className="input input-sm w-full input-bordered" ref={formData.zip_code} />
                            <label className="label">
