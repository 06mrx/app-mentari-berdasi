...
function Create() {
    ...
    const formData = {
        ...
        role_id: 'e49fae29-ba2c-4e56-87b5-fd10f147e0f4' //Tenaga Kesehatan
    }
    ...
    if (!maritalStatuses || !religions || !ranks || !positions || !statuses || !educations || !villages || !workUnits) {
        return <>
            <PageLayout title={'Tambah Tenaga Kesehatan'} hasBackUrl={false}>
    ...
    return <>
        <PageLayout title={'Tambah Tenaga Kesehatan'} hasBackUrl={true} backUrl="/administrator/users">
            ...
            <div className="max-w-3xl mx-auto bg-base-100 rounded-lg shadow-lg p-3">
                <form onSubmit={handleSubmit}>
                    <div className="flex gap-3 w-full">
                        ...
                        <div className="form-control w-full">
                            <label className="label">
                                <span className="label-text font-semibold">NIP / Nomor Registrasi</span>
                                <span className="label-text-alt text-red-500 font-semibold">* Wajib</span>
                            </label>
