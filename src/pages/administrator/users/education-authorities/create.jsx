...
function Create() {
    ...
    const formData = {
        ...
        role_id: '3dc0b2b6-e421-4364-9699-8e5227b3837f' //Dinas Pendidikan
    }
    ...
    if (!maritalStatuses || !religions || !ranks || !positions || !statuses || !educations || !villages || !workUnits) {
        return <>
            <PageLayout title={'Tambah User Dinas Pendidikan'} hasBackUrl={false}>
    ...
    return <>
        <PageLayout title={'Tambah User Dinas Pendidikan'} hasBackUrl={true} backUrl="/administrator/users">
