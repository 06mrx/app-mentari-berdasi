...
function Create() {
    ...
    useEffect(() => {
        fetch(process.env.API + '/api/reference/marital-status/index', {
            method: 'GET',
            headers: {
                'Authorization': 'Bearer 1|HQjkU8OXZWd0Ne2d2OPYKp1oohmJ5ZTIRwbMLt6l'
            }
    ...
    return <>
        <PageLayout title={'Tambah User'} hasBackUrl={false} isNativeBack>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex w-full justify-end gap-3">
                        <Link href={'/administrator/users'}>
                            <button className="btn btn-sm btn-info btn-outline">Kembali</button>
                        </Link>
