...
function Index() {
    ...
    if (!users || !units) {
        return <>
            <PageLayout title={'Daftar Guru'} hasBackUrl={true} backUrl="/headmaster">
                            ...
                            users.data?.data?.map((user, index) => {
                                return (
                                    <tr className="hover" key={index}>
                                            ...
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    <div className="font-bold">
                                                        <Link href={'/headmaster/teachers/' + user.id} className="text-primary underline">
                                        ...
                                        <th>
                                            <div className="flex gap-2">
                                                <Link href={'/administrator/teachers/' + user.id}>
