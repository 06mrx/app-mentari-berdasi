...
export default function Index() {
    ...
    return <>
        <PageLayout title={'Pertumbuhan Siswa'} hasBackUrl={true} backUrl={'/administrator/students/' + id}>
                                ...
                                return (
                                    <tr className="hover" key={index}>
                                        ...
                                        <td>
                                            ...
                                            <span className={getColor(growthDevelopment.status_weight)}>
                                        ...
                                        <td>
                                            ...
                                            <span className={getColor(growthDevelopment.status_height)}>
