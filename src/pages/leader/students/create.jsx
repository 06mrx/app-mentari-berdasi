...
function Create() {
    ...
    useEffect(() => {
        ...
        fetcher('/api/reference/work_unit/list', setWorkUnits);
    ...
    function handleSubmit(event) {
        ...
        fetch(process.env.API + '/api/administrator/student-personal-data/store', {
            method: 'post',
            headers: {
                'Authorization': token,
    ...
    if (!religions || !villages || !workUnits || !residenceTypes || !transportationTypes || !educations || !jobs || !incomes || !reasonReceiveIndonesiaSmartPrograms || !parentTypes) {
        return <>
            <PageLayout title={'Tambah Peserta Didik'} hasBackUrl={true} backUrl="/administrator/students">
            ...
            <div className="max-w-3xl mx-auto bg-base-100 rounded-lg shadow-lg p-3">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex flex-col md:flex-row lg:flex-row md:gap-3 lg:gap-3 w-full">
                        <div className="form-control w-full">
                            <label className="label">
                                <span className="label-text font-semibold">Sekolah</span>
                                <span className="label-text-alt text-red-500 font-semibold">* Wajib</span>
                            </label>
