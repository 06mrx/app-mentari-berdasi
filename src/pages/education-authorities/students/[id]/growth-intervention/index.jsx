...
export default function Index() {
    ...
    const { data: healthActions, mutate } = useSWR(process.env.API + '/api/administrator/student-health-action/index/' + id, id ? fetcher : null);

    if (!healthActions) return <>
        <PageLayout title={'Intervensi Pertumbuhan Peserta Didik'} hasBackUrl={true} backUrl={"/education-authorities/students/" + id}>
