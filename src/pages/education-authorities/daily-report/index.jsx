...
function Index() {
    ...
    const { data: users, mutate } = useSWR(process.env.API + '/api/education-authorities/user/index?page='+ router.query.page, fetcher);
    const handlePagination = (index) => {
        setPageIndex(index)
        router.push({
            pathname: '/education-authorities/daily-report',
    ...
    if (!users) {
        return <>
            <PageLayout title={'Daftar Laporan Harian Kepala Sekolah'} hasBackUrl={true} backUrl="/education-authorities">
                            ...
                            users.data?.data?.map((user, index) => {
                                return (
                                    <tr className="hover" key={index}>
                                            ...
                                            <div className="flex items-center space-x-3">
                                                ...
                                                <div>
                                                    <div className="font-bold">
                                                        <Link href={'/education-authorities/daily-report/' + user.id} className="text-primary underline">
                                        ...
                                        <th>
                                            <div className="flex gap-2">
                                                <Link href={'/education-authorities/daily-report/' + user.id}>
