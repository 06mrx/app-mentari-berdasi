                        ...
                        <tr className="hover">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <div className="font-bold">
                                            <Link href={'/education-authorities/students/1'} className="text-primary underline">
                                                Student Name 1
                                            </Link>
                                        </div>
                            ...
                            <th>
                                <div className="flex gap-2">
                                    ...
                                    <Link href={'/education-authorities/students/1'}>
                            ...
                            <td>
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm opacity-50">Asal Sekolah 2</div>
                                    </div>
                                </div>
                            </td>
                            <td>
