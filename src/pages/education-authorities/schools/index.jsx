...
function Index() {
    return <>
        <PageLayout title={'Daftar Sekolah'} hasBackUrl={true} backUrl="/education-authorities">
            <div className="flex flex-col md:flex-row lg:flex-row w-full  justify-center items-center gap-3 mt-3">
                ...
                <div className="flex w-full lg:w-auto lg:justify-start justify-center gap-3">
                    <select className="select select-bordered select-sm w-full max-w-xs">
                        <option disabled selected>Filter Unit Kerja</option>
                        ...
                        <tr className="hover">
                            ...
                            <td>
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <div className="font-bold">Sekolah 1</div>
                                        <div className="text-sm opacity-50">Kecamtan A</div>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <th>
                                <div className="flex gap-2">
                                    ...
                                    <Link href={'/education-authorities/schools/1'}>
